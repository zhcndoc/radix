...
<Callout.Root my="5" color="gray">
	...
	<Callout.Text>
		It&apos;s strongly recommended to include an{" "}
		<Link
			target="_blank"
		...
		<Link
			target="_blank"
			rel="noopener noreferrer"
			href="https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Reference/Attributes/aria-labelledby"
		>
			<Code>aria-labelledby</Code>
		</Link>{" "}
		prop on Icon Button components since they don&apos;t contain visible text.
		Screen readers rely on this label to announce the button&apos;s purpose to
		users.
	</Callout.Text>
</Callout.Root>
