---
metaTitle: 头像
metaDescription: 个人头像、用户首字母或备用图标。
...
此组件继承自 [Avatar 原始组件](/primitives/docs/components/avatar)。
...
使用 `color` 属性来指派特定的 [颜色](/themes/docs/theme/color)。
